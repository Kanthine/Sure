...
- (void)queryMessageReadCount {
    ...
    [[IMHttpManager sharedInstanced] queryMessageReadStatus:1 msgId:_message.messageId pageSize:50 pageNo:1 completion:^(NSString *err, NSArray *array, NSInteger totalSize) {
    ...
    [[IMHttpManager sharedInstanced] queryMessageReadStatus:2 msgId:_message.messageId pageSize:50 pageNo:1 completion:^(NSString *err, NSArray *array, NSInteger totalSize) {
