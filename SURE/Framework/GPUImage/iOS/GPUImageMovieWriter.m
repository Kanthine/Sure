    ...
    runAsynchronouslyOnContextQueue(_movieWriterContext, ^{
        ...
        void(^write)() = ^()
        {
            ...
            else
            {
                ...
                BOOL isExit = [[NSFileManager defaultManager] fileExistsAtPath:self.assetWriter.outputURL.path];
                
                
                
                NSLog(@"Couldn't write a frame isExit ===  %d",isExit);
