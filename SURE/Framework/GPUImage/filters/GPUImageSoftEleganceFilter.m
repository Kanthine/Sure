...
- (id)init;
{
    ...
    UIImage *image1 = [UIImage imageNamed:@"GPUResourceImage.bundle/lookup_soft_elegance_1.png"];
    UIImage *image2 = [UIImage imageNamed:@"GPUResourceImage.bundle/lookup_soft_elegance_2.png"];
#else
    NSImage *image1 = [NSImage imageNamed:@"GPUResourceImage.bundle/lookup_soft_elegance_1.png"];
    NSImage *image2 = [NSImage imageNamed:@"GPUResourceImage.bundle/lookup_soft_elegance_2.png"];
#endif
