...
- (id)init;
{
    ...
    UIImage *image = [UIImage imageNamed:@"GPUResourceImage.bundle/lookup_miss_etikate.png"];
#else
    NSImage *image = [NSImage imageNamed:@"GPUResourceImage.bundle/lookup_miss_etikate.png"];
#endif
