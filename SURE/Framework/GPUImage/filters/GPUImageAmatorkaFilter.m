...
- (id)init;
{
    ...
    UIImage *image = [UIImage imageNamed:@"GPUResourceImage.bundle/lookup_amatorka.png"];
#else
    NSImage *image = [NSImage imageNamed:@"GPUResourceImage.bundle/lookup_amatorka.png"];
#endif
