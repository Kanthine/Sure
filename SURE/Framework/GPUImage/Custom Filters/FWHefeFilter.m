...
- (id)init
{
    ...
    UIImage *image = [UIImage imageNamed:@"GPUResourceImage.bundle/edgeBurn"];
    imageSource1 = [[GPUImagePicture alloc] initWithImage:image];
    [imageSource1 addTarget:filter atTextureLocation:1];
    [imageSource1 processImage];
    
    UIImage *image1 = [UIImage imageNamed:@"GPUResourceImage.bundle/hefeMap"];
    imageSource2 = [[GPUImagePicture alloc] initWithImage:image1];
    [imageSource2 addTarget:filter atTextureLocation:2];
    [imageSource2 processImage];
    
    UIImage *image2 = [UIImage imageNamed:@"GPUResourceImage.bundle/hefeGradientMap"];
    ...
    UIImage *image3 = [UIImage imageNamed:@"GPUResourceImage.bundle/hefeSoftLight"];
    ...
    UIImage *image4 = [UIImage imageNamed:@"GPUResourceImage.bundle/hefeMetal"];
