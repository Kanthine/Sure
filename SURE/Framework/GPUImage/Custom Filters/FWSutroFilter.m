...
- (id)init
{
    ...
    UIImage *image = [UIImage imageNamed:@"GPUResourceImage.bundle/vignetteMap"];
    imageSource1 = [[GPUImagePicture alloc] initWithImage:image];
    [imageSource1 addTarget:filter atTextureLocation:1];
    [imageSource1 processImage];
    
    UIImage *image1 = [UIImage imageNamed:@"GPUResourceImage.bundle/sutroMetal"];
    imageSource2 = [[GPUImagePicture alloc] initWithImage:image1];
    [imageSource2 addTarget:filter atTextureLocation:2];
    [imageSource2 processImage];
    
    UIImage *image2 = [UIImage imageNamed:@"GPUResourceImage.bundle/softLight"];
    ...
    UIImage *image3 = [UIImage imageNamed:@"GPUResourceImage.bundle/sutroEdgeBurn"];
    ...
    UIImage *image4 = [UIImage imageNamed:@"GPUResourceImage.bundle/sutroCurves"];
