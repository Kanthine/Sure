...
- (id)init
{
    ...
    UIImage *image = [UIImage imageNamed:@"GPUResourceImage.bundle/earlyBirdCurves"];
    imageSource1 = [[GPUImagePicture alloc] initWithImage:image];
    [imageSource1 addTarget:filter atTextureLocation:1];
    [imageSource1 processImage];
    
    UIImage *image1 = [UIImage imageNamed:@"GPUResourceImage.bundle/earlybirdOverlayMap"];
    imageSource2 = [[GPUImagePicture alloc] initWithImage:image1];
    [imageSource2 addTarget:filter atTextureLocation:2];
    [imageSource2 processImage];
    
    UIImage *image2 = [UIImage imageNamed:@"GPUResourceImage.bundle/vignetteMap"];
    ...
    UIImage *image3 = [UIImage imageNamed:@"GPUResourceImage.bundle/earlybirdBlowout"];
    ...
    UIImage *image4 = [UIImage imageNamed:@"GPUResourceImage.bundle/earlybirdMap"];
