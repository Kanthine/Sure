...
- (void)initValues
{
    ...
    UILabel *grayLable = [[UILabel alloc]initWithFrame:CGRectMake(0, kHeightOfTopScrollView - 1, ScreenWidth, 1)];
    grayLable.backgroundColor = RGBA(220, 220, 220,1);
    [_topScrollView addSubview:grayLable];
...
//                                   lineBreakMode:NSLineBreakByTruncatingTail];
        //累计每个tab文字的长度
        textSize.width = ScreenWidth / 2.0;
