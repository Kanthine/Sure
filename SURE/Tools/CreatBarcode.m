...
+ (UIImage *)creatNormalScanLifeWithDataString:(NSString *)dataString
{
    ...
    //5、因为生成的二维码模糊，所以通过createNonInterpolatedUIImageFormCIImage:outputImage来获得高清的二维码图片
    UIImage *barcodeImage = [self createNonInterpolatedUIImageFormCIImage:outputImage withSize:300];
...
+ (UIImage *)SG_generateWithDefaultQRCodeData:(NSString *)data imageViewWidth:(CGFloat)imageViewWidth
{
    ...
    return [CreatBarcode createNonInterpolatedUIImageFormCIImage:outputImage withSize:imageViewWidth];
}
...
+ (UIImage *)creatLogoScanLifeWithDataString:(NSString *)dataString LogoImage:(UIImage *)logoImage LogoScaleToSuperView:(CGFloat)logoScaleToSuperView;
{
    ...
    NSData *qrImageData = [dataString dataUsingEncoding:NSUTF8StringEncoding];
