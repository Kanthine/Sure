...
- (void)ownerCustomButtonClick:(UMSocialPlatformType)platformType
{
    ...
    UMShareWebpageObject *shareURLObject = [UMShareWebpageObject shareObjectWithTitle:@"SURE秀啊" descr:_detaileStr thumImage:[UIImage imageNamed:@"aboutMySelf"]];
    ...
    if ([[UMSocialManager defaultManager] isInstall:platformType] == NO)
    {
        ...
        UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:@"分享失败"  message:string delegate:nil cancelButtonTitle:@"知道了" otherButtonTitles:nil, nil];
        [alertView show];
