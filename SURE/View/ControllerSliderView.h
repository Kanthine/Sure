...
@protocol ControllerSliderViewDelegate;


@interface ControllerSliderView : UIView
...

{
    ...
    __weak id<ControllerSliderViewDelegate> _slideSwitchViewDelegate;
}
...
@property (nonatomic, weak)  id<ControllerSliderViewDelegate> slideSwitchViewDelegate;
...
@protocol ControllerSliderViewDelegate <NSObject>
 ...
 * @result tab个数
 */
- (NSUInteger)numberOfTab:(ControllerSliderView *)view;
 ...
 */
- (UIViewController *)slideSwitchView:(ControllerSliderView *)view viewOfTab:(NSUInteger)number;
 ...
 * @result
 */
- (void)slideSwitchView:(ControllerSliderView *)view panLeftEdge:(UIPanGestureRecognizer*) panParam;
 ...
 * @result
 */
- (void)slideSwitchView:(ControllerSliderView *)view panRightEdge:(UIPanGestureRecognizer*) panParam;
 ...
 * @result
 */
- (void)slideSwitchView:(ControllerSliderView *)view didselectTab:(NSUInteger)number;
