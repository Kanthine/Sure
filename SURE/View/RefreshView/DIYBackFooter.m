...
//    self.s = s;
    ...
    // logo
    UIImageView *logo = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"loginBack"]];
...
- (void)placeSubviews
{
    ...
    self.logo.bounds = CGRectMake(0, 0, ScreenWidth, ScreenHeight);
...
- (void)setPullingPercent:(CGFloat)pullingPercent
{
    ...
    self.label.textColor = TextColor149;
}
