...
@implementation ShippingAddressDAO

+ (ShippingAdress *)parserDataWithDictionary:(NSDictionary *)dictionary CityList:(NSArray *)cityArray
{
    ...
    ShippingAdress *addressModel = [NSEntityDescription insertNewObjectForEntityForName:@"ShippingAdress" inManagedObjectContext:APPDELEGETE.managedObjectContext];

    
//    ShippingAdress *addressModel = [NSEntityDescription insertNewObjectForEntityForName:@"ShippingAdress" inManagedObjectContext:APPDELEGETE.persistentContainer.viewContext];
    ...
    [ShippingAddressDAO insertShippingAdressWithModel:addressModel];
...
+ (NSMutableArray *)parserDataWithShippingAddressArray:(NSArray *)addressArray
{
    ...
    for (int i = 0; i < addressArray.count; i ++)
    {
        ...
        ShippingAdress *addressModel = [ShippingAddressDAO parserDataWithDictionary:attributeDict CityList:cityListArray];
...
{
    NSArray *queryArray = [ShippingAddressDAO queryShippingAdressWithAdressID:adressModel.address_id];
...
//    NSEntityDescription *entity = [NSEntityDescription entityForName:@"ShippingAdress" inManagedObjectContext:APPDELEGETE.persistentContainer.viewContext];
    ...
    //创建一个检索条件的谓词
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"%K = %@",@"address_id", addressID];
